...
```{r}
arcos_md_mingo <- read_csv("data/arcos-md-baltimore-city-24510-pharmacy.csv")
```
...
arcos_md_mingo_trimmed <- arcos_md_mingo %>%
  select(buyer_dea_no, buyer_name, buyer_city, total_dosage_unit, total_records)

#sorting the total shipment
arcos_md_mingo_sorted <- arcos_md_mingo_trimmed %>%
  arrange(desc(total_records))
