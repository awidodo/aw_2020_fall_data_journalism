...
arcos_md_baltimorecity_pharmacies <- arcos_md_baltimore %>%
  select(buyer_name)
...
arcos_md_baltimorecity_trimmed <- arcos_md_baltimore %>%
  select(buyer_name, buyer_dea_no, buyer_city, total_dosage_unit, total_records)
...
# Giant Pharmacy 10365 total shipments
```
...
#Oshinshky, Alan E MD and Jakobovits, Julian MD both got 4 number of pills
```
