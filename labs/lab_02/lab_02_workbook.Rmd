...
arcos_wv_mingo <- read_csv("arcos-wv-mingo-54059-pharmacy.csv")
...
```{r}
acros_md_baltimorecity <- read_csv("arcos-md-baltimore-city-24510-pharmacy.csv")
```
...
#Answer: Giant Pharmacy 10365 total shipments
```
...
#Answer: Oshinshky, Alan E MD and Jakobovits, Julian MD both got 4 number of pills
```
