...
#The titles for the columns are hard to read and understand.
#There are some states that do not have any data in the columns because it didn't meet the criteria and it is filled with an *
#There is a row designated to establish a criteria 
...
opioid_scrape_clean <- opioid_scrape %>%
  ...
  rename(opoid_prescription_rate = opioid_prescriptions_100_persons2_2018 )
